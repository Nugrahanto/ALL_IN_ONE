...
public class TechnologyFragment extends Fragment {
    ...
    private List<TechnologyListItem> listItems;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = (RecyclerView) view.findViewById(R.id.recyclerViewTech);
                    ...
                    public void onResponse(String s) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < array.length(); i++) {
                                ...
                                TechnologyListItem item = new TechnologyListItem(
                                        //kalau ada kurung
                            ...
                            adapter = new TechnologyAdapter(listItems, getActivity().getApplicationContext()); //mengirim ke adapter
